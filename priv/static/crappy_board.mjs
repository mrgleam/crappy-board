...
// build/dev/javascript/crappy_board/crappy_board.mjs
function main() {
  let app = element2(
    div(
      toList([]),
            ...
            li(
              ...
              toList([
                a(
                  toList([href("#")]),
                  toList([
                    h2(toList([]), toList([text("Title #1")])),
                    p(
                      toList([]),
                      toList([text("Text Content #1")])
                    )
                  ])
                )
              ])
            ...
            li(
              ...
              toList([
                a(
                  toList([href("#")]),
                  toList([
                    h2(toList([]), toList([text("Title #2")])),
                    p(
                      toList([]),
                      toList([text("Text Content #2")])
                    )
                  ])
                )
              ])
            ...
            li(
              ...
              toList([
                a(
                  toList([href("#")]),
                  toList([
                    h2(toList([]), toList([text("Title #3")])),
                    p(
                      toList([]),
                      toList([text("Text Content #3")])
                    )
                  ])
                )
              ])
            ...
            li(
              ...
              toList([
                a(
                  toList([href("#")]),
                  toList([
                    h2(toList([]), toList([text("Title #4")])),
                    p(
                      toList([]),
                      toList([text("Text Content #4")])
                    )
                  ])
                )
              ])
            ...
            li(
              ...
              toList([
                a(
                  toList([href("#")]),
                  toList([
                    h2(toList([]), toList([text("Title #5")])),
                    p(
                      toList([]),
                      toList([text("Text Content #5")])
                    )
                  ])
                )
              ])
